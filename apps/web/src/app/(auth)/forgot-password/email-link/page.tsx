...
export default function ForgotPasswordEmailLinkPage() {
    ...
    return (
      <Card>
        <CardHeader className="items-center text-center">
          ...
          <CardDescription>
            If an account exists for that email, we tried to send a link to
            reset your password.
          </CardDescription>
        </CardHeader>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Enter your email and we&apos;ll try to send you a reset link.
          Delivery isn&apos;t guaranteed on this deployment — your{" "}
